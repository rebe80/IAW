...
do
    ...
    # Asegurarse de que nomComp no esté vacío para el atributo cn
    if [ -z "$nomComp" ]; then
        nomComp=$uid # Usar el UID si el nombre completo está vacío
    fi
    ...
    echo "mail: ${uid}@aso.local" >> tmp.ldif # Usando UID para el correo
